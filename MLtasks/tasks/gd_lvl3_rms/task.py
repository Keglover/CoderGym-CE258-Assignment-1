...
BETA = 0.99  # Common default value for RMSProp's moving average factor
...
# RMSProp with PyTorch's built-in implementation
# =================================================================================
...
def main():
    ...
    opt_pt      = rms(model_pt.parameters(), lr=LR, alpha=BETA, eps=EPS)
    ...
    opt_ex     = ManualOptimizer(model_ex.parameters(), lr=LR, beta=BETA, eps=EPS)
